...
shiny::runGitHub("Shiny_Application_and_Reproducible_Pitch", "gaelberon")  
</span>

**Option 3 (local)**: Download the server.R and ui.R files and place them in folder named 'Shiny_Application_and_Reproducible_Pitch'. Open an R session and set the working directory to the folder that contains the directory 'Shiny_Application_and_Reproducible_Pitch'. Then run the following commands:  

<span style="background-color:#eeeeee;padding:3px;">
library(shiny)  
runApp('Shiny_Application_and_Reproducible_Pitch')  
</span>
